...
public class TestAddFriend {
	...
	public void testAddFriend() throws IOException{
		...
		AddFriendMsg.AddFriendRsp responseObject = 
				AddFriendMsg.AddFriendRsp.parseFrom(NetworkPacket.getMessageObjectBytes(resultBytes));
		...
		responseObject =AddFriendMsg.AddFriendRsp.parseFrom(NetworkPacket.getMessageObjectBytes(resultBytes));
